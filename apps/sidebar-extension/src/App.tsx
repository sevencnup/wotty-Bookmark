...
function App() {
  ...
  return <main className="app-shell self-hosted-library">
    ...
    <footer className="app-footer"><span><span className="footer-dot" /> 服务器是唯一数据源</span><span className="footer-version">v0.1.11</span></footer>
