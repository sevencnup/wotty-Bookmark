...
const helpArticles = [
  ...
  { id: 'encryption', title: '为什么后台需要 Floccus passphrase？', keywords: '加密 passphrase 隐私 xbel', content: '启用 Floccus 加密后，后台必须使用同一个 passphrase 才能整理书签。passphrase 会由服务器主密钥加密保存，页面不会显示它；启用后不再是零知识模式，服务器管理员能够解密书签。' },
